...
class WidgetStateReducerTest {
    ...
    private val items = listOf(
        WidgetMediaItem(id = "a", imageUri = null, audioUri = null, displayTitle = "Old Small", sizeBytes = 10, modifiedAtEpochMillis = 100, bucketName = null, pairingConfidence = PairingConfidence.NONE),
        WidgetMediaItem(id = "b", imageUri = null, audioUri = null, displayTitle = "New Medium", sizeBytes = 20, modifiedAtEpochMillis = 300, bucketName = null, pairingConfidence = PairingConfidence.NONE),
        WidgetMediaItem(id = "c", imageUri = null, audioUri = null, displayTitle = "Mid Large", sizeBytes = 30, modifiedAtEpochMillis = 200, bucketName = null, pairingConfidence = PairingConfidence.NONE),
    )
